...
describe('translateFallbackLng', () => {
  ...
  ;[
    ...
    },
    {
      href: {
        locale: 'fr-BE',
        pathname: '/fr-BE/news/[...newsPathPart]',
        query: { newsPathPart: 'a' },
      },
      translatedPath: {
        pathname: '/actualites/a',
    ...
    },
    {
      href: {
        locale: 'fr-FR',
        pathname: '/fr-FR/news/[...newsPathPart]',
        query: { newsPathPart: 'a' },
      },
      translatedPath: {
        pathname: '/actualites/a',
    ...
    },
    {
      locale: 'fr-BE',
      href: '/fr-BE/news/a/b',
      translatedUrl: '/fr-BE/actualites/a/b',
    },
    {
      locale: 'fr-BE',
      href: '/news/a',
      translatedUrl: '/fr-BE/actualites/a',
    },
  ].forEach(({ href, locale = 'fr-FR', translatedPath, translatedUrl }) => {
    const args = [href, locale || 'fr-FR'] as const
    const titleInput = typeof href === 'string' ? href : JSON.stringify(href)
    test(`translateUrl: ${titleInput}`, () => {
      if (translatedPath) {
        expect(translatePath(...args)).toEqual(translatedPath)
